...
cap = cv2.VideoCapture(1)  # 0 označava bočnu kameru (prilagodi prema svojoj postavci)
...
while True:
    ...
    # Prikaz frame-a
    cv2.imshow("Side Camera - Press 's' to save settings", frame)
    ...
    # Pritisni 's' za spremanje postavki
        ...
        with open('side_camera_settings.json', 'w') as f:
            json.dump(settings, f, indent=4)
        print("Postavke za bočnu kameru su spremljene.")
