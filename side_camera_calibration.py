...
class SideCameraCalibrator:
    ...
    def save_calibration_data(self, data):
        ...
        calibration_file = 'calibration_data/side_camera_calibration.json'
...
def main():
    calibrator = SideCameraCalibrator()

    # Učitaj parametre kamere
    calibrator.load_camera_params('side_camera_settings.json')

    cap = cv2.VideoCapture(1)  # Koristi bočnu kameru (index 0)
